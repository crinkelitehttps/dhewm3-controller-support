...
public:
	...
	idAngles			TrackAngleOffset( void ) const;			// returns the current Linuxtrack angle offset
	idVec3				TrackPosOffset( void ) const;			// returns the current Linuxtrack position offset
